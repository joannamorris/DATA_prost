...
This script conducts an ANOVA examining the P600 PROST data with Referentiality and Gender as within variables and Identity Status as a between factor. Analysis 1 examines the data for antecedents are co-indexed with *himself* or *herself*, while Analysis 2 examines the  P600 effect when antecedents are co-indexed with *themselves*
